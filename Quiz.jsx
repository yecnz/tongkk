...
const sampleQuizzes = [
  {
    id: 1, question: "시간 복잡도 O(n log n)을 가지는 정렬 알고리즘은?",
    options: ["버블 정렬", "퀵 정렬", "선택 정렬", "삽입 정렬"],
    answer: 1, explanation: "퀵 정렬의 평균 시간 복잡도는 O(n log n)입니다."
  },
  {
    id: 2, question: "스택(Stack)의 특징으로 올바른 것은?",
    options: ["FIFO 구조", "LIFO 구조", "랜덤 접근 가능", "정렬된 순서 유지"],
    answer: 1, explanation: "스택은 Last In First Out(LIFO) 구조입니다."
  },
  {
    id: 3, question: "이진 탐색의 전제 조건은?",
    options: ["데이터가 정렬되어 있어야 한다", "데이터가 연결 리스트여야 한다", "데이터가 트리 구조여야 한다", "데이터가 해시 테이블이어야 한다"],
    answer: 0, explanation: "이진 탐색은 정렬된 배열에서만 사용할 수 있습니다."
  },
  {
    id: 4, question: "다익스트라 알고리즘의 주요 용도는?",
    options: ["문자열 매칭", "최소 신장 트리", "최단 경로 탐색", "위상 정렬"],
    answer: 2, explanation: "다익스트라 알고리즘은 가중치가 있는 그래프에서 최단 경로를 찾습니다."
  },
  {
    id: 5, question: "해시 충돌 해결 방법이 아닌 것은?",
    options: ["체이닝", "개방 주소법", "이중 해싱", "깊이 우선 탐색"],
    answer: 3, explanation: "깊이 우선 탐색(DFS)은 그래프 탐색 알고리즘으로, 해시 충돌 해결과 무관합니다."
  }
];
    ...
    return (
      <div style={{ background: "#fff", minHeight: "100vh", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        <div style={{ padding: "16px 24px", borderBottom: "1px solid #f0f0f0" }}>
          ...
          <span style={{ marginLeft: 12, color: "#bbb", fontSize: 14 }}>/ 퀴즈 생성</span>
        </div>
    ...
    return (
      <div style={{ background: "#fff", minHeight: "100vh", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          <div style={{
            width: 48, height: 48, border: "3px solid #f0f0f0", borderTop: `3px solid ${PINK}`,
  ...
  if (step === "result") {
    ...
    return (
      <div style={{ background: "#fff", minHeight: "100vh", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        <div style={{ padding: "16px 24px", borderBottom: "1px solid #f0f0f0" }}>
          <span style={{ fontWeight: 700, fontSize: 20, color: PINK }}>Tongkk</span>
          <span style={{ marginLeft: 12, color: "#bbb", fontSize: 14 }}>/ 퀴즈 결과</span>
        </div>
        <div style={{ padding: 24, maxWidth: 500, margin: "40px auto", textAlign: "center" }}>
          <Card style={{ padding: 40 }}>
            ...
            <p style={{ fontSize: 15, color: "#666", margin: "0 0 28px" }}>
              {quizzes.length}문제 중 {correctCount}문제 정답
            </p>
  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      <div style={{ padding: "16px 24px", borderBottom: "1px solid #f0f0f0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
          <span style={{ fontWeight: 700, fontSize: 20, color: PINK }}>Tongkk</span>
          <span style={{ marginLeft: 12, color: "#bbb", fontSize: 14 }}>/ {subject} 퀴즈</span>
        </div>
      ...
      <div style={{ padding: 24, maxWidth: 600, margin: "30px auto" }}>
        <Card style={{ padding: 28 }}>
          ...
          {showExplanation && (
            <div style={{
              marginTop: 20, padding: 16, borderRadius: 12, background: "#FAFAFA",
              borderLeft: `3px solid ${CYAN}`, fontSize: 13, color: "#555", lineHeight: 1.6
            }}>
