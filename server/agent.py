...
5. 강의자료 요약, 퀴즈 생성, 또는 틀린 문제(오답) 분석·복습 요청을 받으면 필요한 도구를 호출해 출력 기준을 확인한 뒤 최종 답변을 작성한다.
...
TOOLS = [study_summary_format, quiz_generation_format, term_explanation_format, wrong_answer_coach_format]
